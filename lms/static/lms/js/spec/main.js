...
(function(requirejs) {
    ...
    requirejs.config({
        ...
        paths: {
          ...
          mathjax: 'https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.5/MathJax.js?config=TeX-MML-AM_HTMLorMML&delayStartupUntil=configured',  // eslint-disable-line max-len
