...
'use strict';
{
  ...
  const newcatalog = {
    ...
    "Do you want to replace the edX transcript with the YouTube transcript?": "M\u00f6chtest du das LP+ADOPT-Transkript durch das YouTube-Transkript ersetzen?",
    ...
    "Help make edX better for everyone!": "Wollen Sie helfen, LP+ADOPT zu verbessern?",
    ...
    "No EdX Timed Transcript": "Kein zeitbehaftetes Transkript von LP+ADOPT",
    ...
    "The timed transcript for this video on edX is out of date, but YouTube has a current timed transcript for this video.": "Das zeitbehaftete Transkript f\u00fcr dieses Video auf LP+ADOPT ist veraltet, aber YouTube hat ein aktuelles zeitbehaftetes Transkript f\u00fcr dieses Video.",
    ...
    "This subsection was released to learners as a special exam, but was reverted back to a basic exam. You may not configure it as a special exam now. Contact edX Support for assistance.": "Dieser Unterabschnitt wurde f\u00fcr die Teilnehmer als Sonderpr\u00fcfung ver\u00f6ffentlicht, anschlie\u00dfend aber wieder zu einer Grundpr\u00fcfung zur\u00fcckgewandelt. Die Pr\u00fcfung kann jetzt nicht mehr als Sonderpr\u00fcfung konfiguriert werden. Wenden Sie sich zur Unterst\u00fctzung an den LP+ADOPT-Support.",
    ...
    "Waiting": "Warten",
    "Want to make edX better for everyone?": "Want to make LP+ADOPT better for everyone?",
    "Warning": "Warnung",
    "Warnings": "Warnungen",
    ...
    "While our support team is happy to assist with the edX platform, the course staff has the expertise for specific assignment questions, grading or the proper procedures in each course. Please post all course related questions within the Discussion Forum where the Course Staff can directly respond.": "W\u00e4hrend unser Support-Team gerne mit der LP+ADOPT-Plattform behilflich ist, verf\u00fcgt das Autoren- und Dozententeam \u00fcber das Fachwissen f\u00fcr spezifische inhaltliche Fragen hinsichtlich Aufgabenstellungen, Benotungen oder zu den richtigen Verfahren in jedem Kurs. Bitte stellen Sie alle kursbezogenen Fragen in dem jeweiligen Diskussionsforum, wo das Autoren- und Dozententeam direkt antworten kann.",
    ...
    "Why does edX collect this information?": "Warum braucht LP+ADOPT diese Information?",
    "Width": "Breite",
    ...
    "Yes, replace the edX transcript with the YouTube transcript": "Ja, ersetze da LP+ADOPT-Transkript durch das YouTube-Transkript",
    "Yesterday": "Gestern",
    "You already belong to another team in this team set.": "Sie geh\u00f6ren bereits zu einem anderen Team in diesem Team-Set.",
    "You already have an edX account with your {enterprise_name} email address.": "Sie haben bereits ein LP+ADOPT Account mit dieser {enterprise_name} E-Mail Adresse.",
    ...
    "Your profile settings are managed by {enterprise_name}. Contact your administrator or {link_start}edX Support{link_end} for help.": "Ihre Profileinstellungen werden von {enterprise_name} verwaltet. Wenden Sie sich an Ihren Administrator oder {link_start}LP+ADOPT Support{link_end} um Hilfe.",
