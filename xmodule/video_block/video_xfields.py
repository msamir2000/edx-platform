...
class VideoFields:
    ...
    download_video = Boolean(
        help=_("Allow students to download versions of this video in different formats if they cannot use the ADOPT video"
    ...
    edx_video_id = String(
        help=_("If you were assigned a Video ID by LPADOPT for the video to play in this component, enter the ID here."
